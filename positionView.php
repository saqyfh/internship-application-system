...
if (isset($_SESSION['admin_id']) && $_SESSION['user_role'] === 'admin') {
    ...
    if ($row == 0) {
        ...
        while ($row = mysqli_fetch_array($query)) {
            ...
            echo "<td><img src='".$row["position_image"]."' alt='Image' style='width: 100px; height: 100px; object-fit: cover;'></td>";
            echo "<td class='center-td'>
                <a href='positionUpdate.php?position_id=" . $row["position_id"] . "' class='edit-btn'>
        ...
        echo "<button class='oval-button'> <a href='positionAdd.php' style='color:#fff;'>+ Add</a></button>";  
