...
<body>
 ...
 <header>
        ...
        <a href="mainPage.php" class="logo"><img src= "logo.png" alt="logo alain"> </a>
        <nav class="navbar">
            <a href="#">Services</a>
            <a href="#">Solutions</a>
            <a href="#">Training</a>
...
<?php
    ...
    if ($row_count == 0) {
        echo "No department available at the moment.";
    } else {
        while ($row = mysqli_fetch_assoc($result)) {
            echo "<div class='package-card'>";
            echo "<img src= '" . $row["department_image"] . "' alt='" . $row["department_name"] . " ' style= width:230px; height:230px;' >";
            echo "<h3>" . $row["department_name"] . "</h3>";
            echo "<span>" . $row["department_desc"] . "</span>";
            echo "</div>";
